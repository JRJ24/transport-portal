    ...
    <main className="auth-page">
      <section className="auth-card">
        ...
        <div className="auth-copy">
          ...
          <p>
            Ingresa con una cuenta ADMIN u OPERATOR para administrar el TMS.
          </p>
        </div>
        <form onSubmit={submit} className="auth-form">
          <label>
            ...
            <input
              ...
              placeholder="admin@rutard.local"
              required
            />
          </label>
          <label>
          ...
          <Button type="submit" disabled={loading}>
            {loading ? "Entrando..." : "Entrar al TMS"}
          </Button>
        </form>
      </section>
      <aside className="auth-side">
        <Truck size={34} />
        <span>
          Las ubicaciones de conductores se reciben por canal realtime y se
          sincronizan con órdenes activas.
        </span>
      </aside>
    </main>
  );
